...
#lines data
datafile='lines_data.npy'
labelfile='lines_labels.npy'
...
output1 = get_outputs(model,'input','dense_C1',X_train[:samples_train])
output2 = get_outputs(model,'input','dense_S1',X_train[:samples_train])
guesses = np.argmax(output1+output2, axis=1)
answers = y_train[:samples_train]
